...
typedef enum EVENT_APP_DOOR_LOCK
{
  ...
  EVENT_APP_DELETE_ALL_YD_SCHEDULES_START,    //!< EVENT_APP_DELETE_ALL_YEAR_DAY_SCHEDULES_START
  EVENT_APP_DELETE_ALL_YD_SCHEDULES_COMPLETE, //!< EVENT_APP_DELETE_ALL_YEAR_DAY_SCHEDULES_COMPLETE
  EVENT_APP_DELETE_ALL_DR_SCHEDULES_START,    //!< EVENT_APP_DELETE_ALL_DAILY_REPEATING_SCHEDULES_START
  EVENT_APP_DELETE_ALL_DR_SCHEDULES_COMPLETE, //!< EVENT_APP_DELETE_ALL_DAILY_REPEATING_SCHEDULES_COMPLETE
}
EVENT_APP; 
