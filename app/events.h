...
typedef enum EVENT_APP_DOOR_LOCK{
  ...
  EVENT_APP_DELETE_ALL_YD_SCHEDULES_START, ///! EVENT_APP_DELETE_ALL_YD_SCHEDULES_START
  EVENT_APP_DELETE_ALL_DR_SCHEDULES_START, ///! EVENT_APP_DELETE_ALL_DR_SCHEDULES_START
  EVENT_APP_DELETE_USER_HEAD,              ///! EVENT_APP_DELETE_USER_HEAD
  EVENT_APP_DELETE_YD_SCHEDULES_HEAD,      ///! EVENT_APP_DELETE_YD_SCHEDULES_HEAD
  EVENT_APP_DELETE_DR_SCHEDULES_HEAD,      ///! EVENT_APP_DELETE_DR_SCHEDULES_HEAD
  EVENT_APP_TOGGLE_SCHEDULE_ENABLE_HEAD,   ///! EVENT_APP_TOGGLE_SCHEDULE_ENABLE_HEAD
}
EVENT_APP;
