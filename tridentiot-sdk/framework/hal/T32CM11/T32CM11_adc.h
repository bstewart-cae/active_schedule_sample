...
/// @file T32CM11_adc.h
///
/// @brief This is the chip specific include file for T32CM11 ADC Driver
...
#ifndef T32CM11_ADC_H_
#define T32CM11_ADC_H_

#include "tr_hal_platform.h"

/// ****************************************************************************
/// @defgroup tr_hal_adc_cm11 ADC CM11
...
/// ******************************************************************
/// ADC IDs
/// there are only 4 ADC channels since there are only 4 valid
/// GPIOs to use
/// ******************************************************************
typedef enum
{
...
/// ******************************************************************
/// valid pins for ADC
/// we use pin 28 as the default
/// this is the first of 4 pins that are available (28, 29, 30, 31)
/// ******************************************************************
...
typedef struct
{
    ...
    __IO CHAN_SETTINGS_T ch_x_setting[10];     // 0x20 - 0xBC
    ...
    //__IO uint32_t analog_settings0;          // 0xBC
    __IO tr_sadc_ana_set1_t analog_settings1;  // 0xC0

    // reserved
    __IO uint32_t reserved2[15];               // 0xC4 - 0xFC
    ...
    __IO uint32_t dma_reserved1;               // 0x110
...
// bits 16 to 27 = ADC adjust value, used for calibration
