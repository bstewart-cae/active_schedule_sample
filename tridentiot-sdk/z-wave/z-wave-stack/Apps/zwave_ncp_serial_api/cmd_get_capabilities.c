...
/*
 * Defines a handler for FUNC_ID_SERIAL_API_GET_CAPABILITIES.
 */
#include <stdint.h>
...
static uint8_t SERIALAPI_CAPABILITIES[CAPABILITIES_SIZE] = {
  0,   // Major application version is set runtime
  0,   // Minor application version is set runtime
...
{
  SERIALAPI_CAPABILITIES[0] = zpal_get_app_version_major();
  SERIALAPI_CAPABILITIES[1] = zpal_get_app_version_minor();
