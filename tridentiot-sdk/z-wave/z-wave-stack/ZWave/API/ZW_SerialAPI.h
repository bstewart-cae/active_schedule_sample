...
/**
 * Firmware Update Command ID
 */
#define FUNC_ID_FIRMWARE_UPDATE                         0x3E
...
/// @sa: https://github.com/Z-Wave-Alliance/CSWG/issues/27
#define FUNC_ID_ZW_GET_MANUFACTURER_INFO                0xEA
