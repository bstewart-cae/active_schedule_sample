...
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_LENGTH_USER_NAME <= U3C_BUFFER_SIZE_USER_NAME,
...
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_PIN_CODE <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_PIN_Code_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_PASSWORD <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_Password_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_RFID_CODE <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_RFID_Code_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_BLE <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_BLE_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_NFC <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_NFC_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_UWB <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_UWB_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_EYE_BIOMETRIC <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_Eye_Biometric_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_FACE_BIOMETRIC <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_Face_Biometric_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_FINGER_BIOMETRIC <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_Finger_Biometric_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_HAND_BIOMETRIC <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
              STATIC_ASSERT_FAILED_Maximum_length_Hand_Biometric_data_does_not_fit_in_buffer);
STATIC_ASSERT(CC_USER_CREDENTIAL_MAX_DATA_LENGTH_UNSPECIFIED_BIOMETRIC <= U3C_BUFFER_SIZE_CREDENTIAL_DATA,
...
STATIC_ASSERT((CC_USER_CREDENTIAL_MAX_LENGTH_USER_NAME & 0x01)  == 0,
...
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_PIN_CODE <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_PIN_CODE,
              STATIC_ASSERT_FAILED_Minimum_length_PIN_Code_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_PASSWORD <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_PASSWORD,
              STATIC_ASSERT_FAILED_Minimum_length_Password_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_RFID_CODE <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_RFID_CODE,
              STATIC_ASSERT_FAILED_Minimum_length_RFID_Code_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_BLE <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_BLE,
              STATIC_ASSERT_FAILED_Minimum_length_BLE_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_NFC <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_NFC,
              STATIC_ASSERT_FAILED_Minimum_length_NFC_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_UWB <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_UWB,
              STATIC_ASSERT_FAILED_Minimum_length_UWB_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_EYE_BIOMETRIC <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_EYE_BIOMETRIC,
              STATIC_ASSERT_FAILED_Minimum_length_Eye_Biometric_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_FACE_BIOMETRIC <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_FACE_BIOMETRIC,
              STATIC_ASSERT_FAILED_Minimum_length_Face_Biometric_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_FINGER_BIOMETRIC <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_FINGER_BIOMETRIC,
              STATIC_ASSERT_FAILED_Minimum_length_Finger_Biometric_data_must_be_less_than_maximum_length);
STATIC_ASSERT(CC_USER_CREDENTIAL_MIN_DATA_LENGTH_HAND_BIOMETRIC <= CC_USER_CREDENTIAL_MAX_DATA_LENGTH_HAND_BIOMETRIC,
