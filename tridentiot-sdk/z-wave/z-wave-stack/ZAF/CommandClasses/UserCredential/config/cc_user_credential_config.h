 ...
 */
/**
 * @file cc_user_credential_config.h
...
/**
 * Minimum length of PIN Code data <1..255:1>
 *
 */
...
/**
 * Minimum length of Password data <2..255:2>
 *
 */
...
/**
 * Maximum length of PIN Code data <1..255:1>
 *
 */
...
/**
 * Maximum length of Password data <2..255:2>
 *
 */
...
/**
 * Number of Year Day Schedules Supported by Each User <0..2:1>
 *
 */
#if !defined(CC_USER_CREDENTIAL_YEAR_DAY_SCHEDULES_PER_USER)
#define CC_USER_CREDENTIAL_YEAR_DAY_SCHEDULES_PER_USER  1
#endif /* !defined(CC_USER_CREDENTIAL_YEAR_DAY_SCHEDULES_PER_USER) */

/**
 * Number of Daily Repeating Schedules Supported by Each User <0..7:1>
 *
 */
#if !defined(CC_USER_CREDENTIAL_DAILY_REPEATING_SCHEDULES_PER_USER)
#define CC_USER_CREDENTIAL_DAILY_REPEATING_SCHEDULES_PER_USER  3
#endif /* !defined(CC_USER_CREDENTIAL_DAILY_REPEATING_SCHEDULES_PER_USER) */

/**
 * Number of Key Locker DESFire ID slots <0..10:1>
 *
 * Also defines whether this Key Locker slot type is supported or not. 0 Slots imply no support, any other number implies support.
 */
#if !defined(CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_SLOT_COUNT)
#define CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_SLOT_COUNT  0
#endif /* !defined(CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_SLOT_COUNT) */

/**
 * Key Locker DESFire App ID Min Length <3..35:1>
 *
 */
#if !defined(CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_MIN_LENGTH)
#define CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_MIN_LENGTH  3
#endif /* !defined(CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_MIN_LENGTH) */

/**
 * Key Locker DESFire App ID Max Length <35..255:1>
 *
 */
#if !defined(CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_MAX_LENGTH)
#define CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_MAX_LENGTH  35
#endif /* !defined(CC_USER_CREDENTIAL_KEY_LOCKER_DESFIRE_MAX_LENGTH) */
...
/**
 * Support User Scheduling via Active Schedule CC
 *
 */
#if !defined(CC_USER_CREDENTIAL_USER_SCHEDULING_SUPPORTED)
#define CC_USER_CREDENTIAL_USER_SCHEDULING_SUPPORTED  0
#endif /* !defined(CC_USER_CREDENTIAL_USER_SCHEDULING_SUPPORTED) */
