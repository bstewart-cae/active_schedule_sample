 ...
 */
/**
 * @file cc_active_schedule_config.h
...
/**
 * Maximum number of CCs using Active Schedule that are supported by the node <1..3:1>
 *
 */
#if !defined(CC_ACTIVE_SCHEDULE_MAX_NUM_SUPPORTED_CCS)
#define CC_ACTIVE_SCHEDULE_MAX_NUM_SUPPORTED_CCS  1
#endif /* !defined(CC_ACTIVE_SCHEDULE_MAX_NUM_SUPPORTED_CCS) */
