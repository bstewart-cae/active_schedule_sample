...
/* External APIs*/
extern bool RfMcu_CpuInit(
    const uint8_t *image_path,
    uint32_t image_size,
    RF_MCU_SYSTEM_CONFIG_PTR_t sys_config
);

extern bool RfMcu_CpuStart(RF_MCU_SYSTEM_CONFIG_PTR_t sys_config);
...
extern void RfMcu_BmuReset(void);
extern void RfMcu_EventQueueReset(void);
