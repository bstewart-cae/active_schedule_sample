/// ***************************************************************************
///
/// @file cz20_fota_define.h
///
/// @brief Defines structures and addresses used by the bootloader
///
/// SPDX-License-Identifier: LicenseRef-TridentMSLA
/// SPDX-FileCopyrightText: 2025 Trident IoT, LLC <https://www.tridentiot.com>
/// ***************************************************************************
#ifndef _CZ20_FOTA_DEFINE_H_
#define _CZ20_FOTA_DEFINE_H_
...
/**
 * @brief Selected a flash programming size at once from flashProgramSizeDef "Flash programming size definition list".
 *
 * @attention Please update the definition of FLASH_PROGRAM_SIZE_FOR_POWER_OF_2 if change the definition of @ref FLASH_PROGRAM_SIZE.
*/
...
#define FOTA_UPDATE_BANK_INFO_ADDRESS                 0x10007000          /**< Address of FOTA update information*/
#define APP_START_ADDRESS                             0x10008000          /**< Start address of application code.*/
...
#define FOTA_IMAGE_INFO_ENCRYPTED                           0x04
...
typedef struct  __attribute__((packed))
{
    ...
    fotaimage_info  fota_image_info;                      /* The FOTA image options (signed/compressed/encrypted) */
    uint8_t         fota_encryption_iv[FOTA_AES_IV_SIZE]; /* Initial vector used for encryption */
    uint32_t        signature_len;                        /* The length to generate signature */
    uint8_t         reserved_[2];                         /* Reserved for future use */
    uint32_t        max_image_size;                       /* Maximum allowed size of the application image */
    uint32_t        image_binary_size;                    /* size of the binary uncompressed image */
